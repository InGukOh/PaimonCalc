...
public class OutlineTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        stroke = type.getBoolean(R.styleable.OutlineTextView_textStroke, true); // 외곽선 유무
        strokeWidth = type.getFloat(R.styleable.OutlineTextView_textStrokeWidth, 6); // 외곽선 두께
        strokeColor = type.getColor(R.styleable.OutlineTextView_textStrokeColor, 0xFFFFFF); // 외곽선
    }
